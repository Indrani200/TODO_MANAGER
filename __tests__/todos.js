...
describe("Todo test suite", () => {
  ...
  test("Creates a todo", async () => {
    ...
    await login(agent, "usera@outlook.org", "123456789");
  ...
  test("userA cannot delete userB's todo", async () => {
    const agent = request.agent(server);
    await login(agent, "testa@outlook.org", "123456789");
    ...
    await login(agent, "testb@outlook.org", "123456789");
